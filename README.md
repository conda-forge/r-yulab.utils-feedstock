...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-yulab.utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13768&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-yulab.utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-yulab.utils` can be installed with:

```
conda install r-yulab.utils
```

It is possible to list all of the versions of `r-yulab.utils` available on your platform with:

...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-yulab.utils-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-yulab.utils-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-yulab.utils
# for installing globally
pixi global install r-yulab.utils
```
...
It is possible to list all of the versions of `r-yulab.utils` available on your platform:
...
```
pixi search r-yulab.utils --channel conda-forge
```
